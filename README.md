...
## 5. AI Agent 기반 검색·추천 경험 (2024–)

### Background

기존 Smart TV 검색 서비스는 **추천 결과의 이유를 사용자에게 설명하기 어려웠고**,  
복합적인 사용자 의도를 가진 음성 입력에서는 **탐색 흐름이 단절되는 한계**가 있었습니다.

### Challenge

사용자가 검색·추천 결과와 그 **근거를 함께 이해**할 수 있도록 하는 새로운 탐색 경험 설계가 필요했습니다.

### Work

- 기획 조직과 협업해 **사용자 탐색 흐름을 재정의**하고, AI Agent를 도입하기로 결정
- **검색 서버팀 리더 및 PL**로서 기술 구조와 협업 방향 주도
- G사 담당자들과 LLM의 특성과 제약을 검색 도메인 관점에서 검토
- **Node.js 및 Elasticsearch 기반 RAG 구조**를 설계하여 검색 결과를 근거로 응답 생성
- 기획 조직과 함께 **Agent 동작 범위 정의** 및 UX·안정성 조율
